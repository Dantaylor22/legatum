...
export const PROFILE_FIELDS = {
  child: [
    ...
    { id: 'school_type',     label: 'School type',            type: 'select',   options: ['Nursery','Primary','Secondary','Sixth form / College','University','Other / Enter manually'] },
    { id: 'school_name',     label: 'School name',            type: 'text' },
    { id: 'school_address',  label: 'School address',         type: 'text' },
    { id: 'school_phone',    label: 'School phone number',    type: 'text' },
    { id: 'school_year',     label: 'School year / class',    type: 'text' },
  ...
  pet: [
    ...
    { id: 'species',         label: 'Species (e.g. Dog, Cat)', type: 'text',     required: true },
    ...
    { id: 'insurance_expiry',label: 'Insurance expiry date',  type: 'date',     expiryRelevant: true },
